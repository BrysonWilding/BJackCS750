...
var Game = function(startMoney) {
    ...
    /** private object declarations **/
        var Deck = function() {
            ...
            this.hit = function(hand) { hand.addCard(this.getCard()); };
            this.getCard = function() { return cardArray.pop(); };
            this.showCards = function() { return cardArray; };
        ...
        var Hand = function(card) {
            ...
            this.addCard =function(card) { hand.push(card); };
            this.split = function() {
                /////// ?
            };
            this.total = function() {
        ...
        var Card = function(obj) {
            ...
            switch(value) {
                case 1: value = "ace"; pointValue = 1; break;
                case 11: value = "jack"; pointValue = 10; break;
                case 12: value = "queen"; pointValue = 10; break;
                case 13: value = "king"; pointValue = 10; break;
                default: pointValue = value; value = value + "";
            }
